 ...
 */
double
kjg_geno_mean (uint8_t *x, size_t n);
 ...
 */
int
kjg_geno_normalize (uint8_t *x, double *y, size_t n);
 ...
 */
int
kjg_geno_normalize_m (double m, uint8_t* x, double* y, size_t n);
 ...
 */
void
kjg_geno_remap (double s[4], uint8_t* x, double* y, size_t n);
 ...
 */
int
kjg_geno_normalization_lookup (double m, double s[4]);
...
void
kjg_geno_unpack (uint8_t* x, SNP *cupt, Indiv **indivmarkers, size_t numindivs);
...
void
kjg_geno_get_row (uint8_t* x, SNP **snpmarkers, Indiv **indivmarkers,
                  size_t numsnps, size_t numindivs, size_t i);
...
void
kjg_geno_get_normalized_row (uint8_t* x, double* y, SNP **snpmarkers,
                             Indiv **indivmarkers, size_t numsnps,
                             size_t numindivs, double* M, size_t i);
...
size_t
kjg_geno_get_normalized_rows (uint8_t* x, double* Y, SNP **snpmarkers,
                              Indiv **indivmarkers, size_t numsnps,
                              size_t numindivs, double* M, size_t i, size_t r);
...
void
kjg_geno_row_means (SNP **snpmarkers, Indiv **indivmarkers, size_t numsnps,
                    size_t numindivs, double* M);
