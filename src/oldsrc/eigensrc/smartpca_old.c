...
domult_increment_normal (pthread_t* threads, uint32_t thread_ct,
                         double* XTX_lower_diag, double* tblock, int marker_ct,
                         uint32_t indiv_ct);
void
...
void
domult_increment_normal (pthread_t* threads, uint32_t thread_ct,
                         double* XTX_lower_diag, double* tblock, int block_size,
                         uint32_t indiv_ct)
{
...
void
dumpgrmbin (double *XTX, int *xindex, int nrows, int numsnps,
         ...
         int numindivs, char *grmoutname)
{
  ...
  if (grmbinary)
    {
      dumpgrmbin (XTX, xindex, nrows, numsnps, indivmarkers, numindivs,
                  grmoutname);
      return;
    }
